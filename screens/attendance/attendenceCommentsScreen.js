...
const AttendanceCommentsScreen = ({ navigation }) => {
  return (
        ...
        <ScrollView>
          <View style={styles.comment_ctn}>
            ...
            <View>
              ...
              <View style={{ width: "90%" }}>
                <Text style={styles.comment}>Checked out while sick</Text>
              </View>
            </View>
          </View>
          <Divider />
...
export default AttendanceCommentsScreen;
