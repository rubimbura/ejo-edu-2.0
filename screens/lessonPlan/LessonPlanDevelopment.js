import {
  ...
  const LessonPlanDevelopemnt = ({ navigation }) => {
    const handleSubmit = () => {
      navigation.navigate("lessonPlanConculusion");
    };
          ...
          <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <Animatable.View
              ...
              <ScrollView style={styles.scrollCtn} showsVerticalScrollIndicator={false}>
                <ModuleHeaderText placeholder="Development"/>
  ...
  export default LessonPlanDevelopemnt;
